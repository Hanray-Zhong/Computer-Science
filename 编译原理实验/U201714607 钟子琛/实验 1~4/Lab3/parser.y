...
/*%token EXT_DEF_LIST EXT_VAR_DEF FUNC_DEF FUNC_DEC EXT_DEC_LIST PARAM_LIST PARAM_DEC VAR_DEF DEC_LIST DEF_LIST COMP_STM STM_LIST  IF_THEN IF_THEN_ELSE
%token /*FUNC_CALL ARGS*/ EXP_STMT FUNCTION PARAM ARG CALL LABEL GOTO JLT JLE JGT JGE EQ NEQ
...
Program: ExtDefList    {semantic_Analysis0($1);/*display($$,0);*/}   
         ; 
ExtDefList:     {$$=NULL;}
